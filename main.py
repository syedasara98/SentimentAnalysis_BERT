...
print("TRAIN_TAKE1",train.take(1))
print("TRAIN_TAKE",train.take)
...
def convert_examples_to_tf_dataset(examples,tokenizer,max_length=128):
    ...
    for e in examples:
        input_dict=tokenizer.encode_plus(e.text_a,add_special_tokens=True,max_length=max_length, return_token_type_ids=True,return_attention_mask=True,truncation=True)
